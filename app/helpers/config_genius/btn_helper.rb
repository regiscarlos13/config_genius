...
module ConfigGenius
  module BtnHelper # :nodoc:
    def btn_new(link, options = nil)
      link_to link, class: 'btn  btn-outline-secondary btn-icon-split btn-sm d-print-none', title: 'Novo Registro',
                    remote: options do
    ...
    def btn_edit(link, options = nil)
      link_to link, class: 'btn btn-outline-secondary btn-icon-split btn-sm  d-print-none', title: 'Editar Registro',
                    remote: options do
    ...
    def btn_show(link, options = nil)
      link_to link, class: 'btn btn-info btn-icon-split btn-sm d-print-none', title: 'Listar Registros',
                    remote: options do
    ...
    def btn_delete(link, options = nil)
      button_to link, class: 'btn btn-outline-danger btn-icon-split btn-sm d-print-none', method: :delete, data: {
    ...
    def btn_print(link, options = nil)
      link_to link, format: :pdf, class: 'btn btn-outline-primary btn-icon-split btn-sm d-print-none', target: '_blank',
                    title: 'Imprimir Registro', remote: options do
    ...
    def btn_cancel(link, options = nil)
      link_to link, class: 'btn btn-outline-danger btn-icon-split btn-sm d-print-none', title: 'Cancelar Registro',
                    remote: options do
    ...
    def btn_back(link, options = nil)
      link_to link, class: 'btn btn-outline-primary btn-icon-split btn-sm d-print-none', title: 'Voltar',
                    remote: options do
    ...
    def btn_save(options = nil)
      button_tag class: 'btn btn-outline-success btn-icon-split btn-sm d-print-none', title: 'Salvar Registro',
